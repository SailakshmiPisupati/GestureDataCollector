...
public class WindowAddOverlay extends RelativeLayout {

    public WindowAddOverlay(Context context) {
        super(context);
    }
    ...
    public WindowAddOverlay(OverlayService service, int layoutResId, int notificationId) {
        super(service);
